    ...
    <div className="flex flex-col sm:flex-row gap-4 w-full">
      ...
      <button
        ...
        className={`
          ...
          ${disabled ? "opacity-50 cursor-not-allowed" : "hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0_0_var(--color-up)]"}
      ...
      <button
        ...
        className={`
          ...
          ${disabled ? "opacity-50 cursor-not-allowed" : "hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0_0_var(--color-down)]"}
